 ...
 */
@WebServlet(name = "Admin_CastrationQueryServlet")
public class Admin_CastrationQueryServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<CastrationBean> castrationBeen = castrationDao.queryCastration(userId);
        Gson gson = new Gson();
        Type listType = new TypeToken<LinkedList<RogueBean>>() {
        }.getType();
        String json = gson.toJson(castrationBeen, listType);
